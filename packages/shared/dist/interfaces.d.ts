import { RolesBase, TipoDescuento, EstatusInvitacion, UnidadesLongitud, Acciones, UnidadesPeso, PeriodosGarantia, EstatusOrden, EstatusArchivo, TipoTransaccion, EstatusPago, MetodoPago, Transportistas, QbTipoInventario, TipoOrden, TipoReporte, SocketTipoMensaje } from "./enums";
